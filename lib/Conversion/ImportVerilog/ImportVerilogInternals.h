...
struct Context {
  ...
  /// Synthetic global that tracks whether assertion control updates are locked.
  /// Controlled by $assertcontrol(1)/$assertcontrol(2).
  moore::GlobalVariableOp assertionControlLockedGlobal;
