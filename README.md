...
Matrix `results.tsv` now includes stable `config_error_code` plus
`config_error_reason`, making lane
...
- `lanes.tsv`:
  ...
  `quality-smoke|quality-nightly|quality-strict|native-quality-nightly`).
