...
- `ninja -C build_test CIRCTSimToolTests` (PASS)
- `build_test/unittests/Tools/circt-sim/CIRCTSimToolTests --gtest_filter='LLHDProcessInterpreterToolTest.JITRejectsStoreAddressDerivedFromProbe:LLHDProcessInterpreterToolTest.JITRejectsHotBlockWithBranchTerminator:LLHDProcessInterpreterToolTest.JITHotBlockUsesResumeBlockWait'` (PASS)
- `bash -n utils/run_regression_unified.sh` (PASS)
...
- `ninja -C build_test CIRCTSimToolTests` (PASS)
- `build_test/unittests/Tools/circt-sim/CIRCTSimToolTests --gtest_filter='LLHDProcessInterpreterToolTest.JITDriveClearsUnusedHighBits:LLHDProcessInterpreterToolTest.JITDriveFutureDelayDefersToNBA:LLHDProcessInterpreterToolTest.JITRejectsNonIntegerSignalPayloadType'` (PASS)
- `bash -n utils/run_regression_unified.sh` (PASS)
