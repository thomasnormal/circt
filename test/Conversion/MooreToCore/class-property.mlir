...
// CHECK:   [[GEP:%.+]] = llvm.getelementptr %arg0[{{%.+}}, 2] : (!llvm.ptr, i32) -> !llvm.ptr, !llvm.struct<"SimpleClass"
...
// CHECK:   [[GEP:%.+]] = llvm.getelementptr %arg0[{{%.+}}, 3] : (!llvm.ptr, i32) -> !llvm.ptr, !llvm.struct<"SimpleClass"
...
// CHECK:   [[GEP:%.+]] = llvm.getelementptr %arg0[{{%.+}}, 1] : (!llvm.ptr, i32) -> !llvm.ptr, !llvm.struct<"DerivedClass"
// CHECK:   [[CAST:%.+]] = builtin.unrealized_conversion_cast [[GEP]] : !llvm.ptr to !llhd.ref<i32>
// CHECK:   return [[CAST]] : !llhd.ref<i32>
