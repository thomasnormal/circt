...
// CHECK: [[VAL0:%.+]] = hw.constant 0 : i2
// CHECK: [[UNK1:%.+]] = hw.constant -1 : i2
// CHECK: [[OOB:%.+]] = hw.struct_create ([[VAL0]], [[UNK1]]) : !hw.struct<value: i2, unknown: i2>
// CHECK: llhd.sig [[OOB]] : !hw.struct<value: i2, unknown: i2>
