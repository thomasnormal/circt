...
// Test that negedge-gated delay buffer updates use proper clock edge detection.
// The negedge is computed as: old_clock AND NOT new_clock.

// CHECK-LABEL: func.func @bmc_delay_buffer_negedge() -> i1
// CHECK: scf.for
...
func.func @bmc_delay_buffer_negedge() -> i1 {
