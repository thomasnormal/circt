...
// Shared ltl.delay across multiple clock domains is cloned per property.
// CHECK-LABEL: func.func @delay_multiclock_conflict
// CHECK: scf.for
// CHECK: func.call @bmc_circuit
// CHECK-LABEL: func.func @bmc_circuit
func.func @delay_multiclock_conflict() -> i1 {
  ...
  ^bb0(%clk0: !seq.clock, %clk1: !seq.clock, %sig: i1):
    ...
    verif.assert %del {bmc.clock = "clk0"} : !ltl.sequence
    verif.assert %del {bmc.clock = "clk1"} : !ltl.sequence
    verif.yield %sig : i1
  }
  func.return %bmc : i1
}
