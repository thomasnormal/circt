...
// Test that edge=both clock gating via ltl.clock is handled inside bmc_circuit.
// The circuit returns !smt.bool which incorporates the edge detection.

// CHECK-LABEL: func.func @bmc_clock_op_check_edge_both() -> i1
// CHECK: scf.for
...
// CHECK:   smt.not
// CHECK:   smt.and
func.func @bmc_clock_op_check_edge_both() -> i1 {
  ...
  ^bb0(%clk0: !seq.clock, %clk1: !seq.clock):
    ...
    %clocked = ltl.clock %true, edge %clk1_i1 : !ltl.property
