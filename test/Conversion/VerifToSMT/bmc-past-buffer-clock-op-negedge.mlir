...
// Test that past buffer updates are gated by negedge derived from ltl.clock.

// CHECK-LABEL: func.func @bmc_past_buffer_clock_op_negedge() -> i1
// CHECK: scf.for
...
func.func @bmc_past_buffer_clock_op_negedge() -> i1 {
