...
// relative to the primary BMC clock. A posedge on the derived clock should
// gate delay buffers on the base clock negedge.

// CHECK-LABEL: func.func @bmc_derived_inverted_clock() -> i1
// CHECK: scf.for
...
func.func @bmc_derived_inverted_clock() -> i1 {
