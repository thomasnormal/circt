...
// Test derived clock mapping when verif.assume has a constant-true enable.

// CHECK-LABEL: func.func @bmc_derived_clock_assume_enable_true() -> i1
// CHECK: scf.for
// CHECK: smt.ite
func.func @bmc_derived_clock_assume_enable_true() -> i1 {
