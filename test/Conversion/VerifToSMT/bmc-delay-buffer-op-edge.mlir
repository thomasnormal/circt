...
// Test that delay buffer updates are gated by negedge from the delay op attributes.
...
func.func @bmc_delay_buffer_op_edge() -> i1 {
  ...
  ^bb0(%clk: !seq.clock, %sig: i1):
    %seq = ltl.delay %sig, 1, 0 {bmc.clock = "clk", bmc.clock_edge = #ltl<clock_edge negedge>} : i1
