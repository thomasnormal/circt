...
// Test derived inverted clock mapping via comb.icmp ne.

// CHECK-LABEL: func.func @bmc_derived_inverted_clock_ne() -> i1
// CHECK: scf.for
...
func.func @bmc_derived_inverted_clock_ne() -> i1 {
