...
// Test that delay buffer updates use clock/edge from assert's bmc attributes.
// The negedge is computed as: old_clock AND NOT new_clock.

// CHECK-LABEL: func.func @bmc_delay_buffer_assert_clock_attr() -> i1
// CHECK: scf.for
...
func.func @bmc_delay_buffer_assert_clock_attr() -> i1 {
