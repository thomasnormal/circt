...
// Test that a posedge ltl.clock on an inverted clock value maps to negedge
// gating of the underlying BMC clock.

// CHECK-LABEL: func.func @bmc_clock_op_inverted_posedge() -> i1
// CHECK: scf.for
...
func.func @bmc_clock_op_inverted_posedge() -> i1 {
