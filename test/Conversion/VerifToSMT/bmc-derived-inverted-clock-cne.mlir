...
// Test derived inverted clock mapping via case inequality (comb.icmp cne).

// CHECK-LABEL: func.func @bmc_derived_inverted_clock_cne() -> i1
// CHECK: scf.for
...
func.func @bmc_derived_inverted_clock_cne() -> i1 {
  ...
  ^bb0(%clk: !seq.clock, %drv: i1, %sig: i1):
    ...
    %eq = comb.icmp cne %clk_i1, %drv : i1
    verif.assume %eq : i1
