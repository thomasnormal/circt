...
// SMTLIB: smt.solver
// SMTLIB-DAG: signal_group_depth = 3 : i32
// SMTLIB-DAG: signal_lhs_group_depth = 2 : i32
// SMTLIB-DAG: iff_group_depth = 2 : i32
// SMTLIB-DAG: witness_name = "event_arm_witness_0_0"
// SMTLIB: smt.declare_fun "event_arm_witness_0_0" : !smt.bool
// SMTLIB: smt.and

// RUNTIME: smt.solver
// RUNTIME-DAG: signal_group_depth = 3 : i32
// RUNTIME-DAG: signal_lhs_group_depth = 2 : i32
// RUNTIME-DAG: iff_group_depth = 2 : i32
...
func.func @bmc_event_arm_witness_group_structured() {
  %bmc = verif.bmc bound 1 num_regs 0 initial_values [] attributes {
    ...
    bmc_event_source_details = [[{edge = "both", iff_group_depth = 2 : i32, iff_lsb = 1 : i32, iff_msb = 1 : i32, iff_name = "bus", kind = "signal", label = "signal[0]:both:iff", signal_bin_op = "and", signal_group_depth = 3 : i32, signal_index = 0 : i32, signal_lhs_group_depth = 2 : i32, signal_lhs_lsb = 0 : i32, signal_lhs_msb = 0 : i32, signal_lhs_name = "bus", signal_rhs_name = "en"}]]
  }
  init {
    verif.yield
  }
