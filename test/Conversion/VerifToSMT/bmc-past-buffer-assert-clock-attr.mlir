...
// Test that past buffer updates use clock/edge from the assert's bmc attributes.

// CHECK-LABEL: func.func @bmc_past_buffer_assert_clock_attr() -> i1
// CHECK: scf.for
...
func.func @bmc_past_buffer_assert_clock_attr() -> i1 {
