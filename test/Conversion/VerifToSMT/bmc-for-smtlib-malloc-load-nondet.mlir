...
func.func @for_smtlib_legalizes_malloc_scalar_loads() -> (i1) {
  ...
  ^bb0(%clk: !seq.clock):
    ...
    %field = llvm.getelementptr %ptr[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(i1)>
    %v = llvm.load %field : !llvm.ptr -> i1
    verif.assert %v : i1
    verif.yield %v : i1
  }
  func.return %bmc : i1
...
// CHECK-LABEL: func.func @for_smtlib_legalizes_malloc_scalar_loads()
// CHECK: smt.solver
