...
// Test derived clock mapping via wildcard inequality (comb.icmp wne)
// which implies inversion of the derived clock.

// CHECK-LABEL: func.func @bmc_derived_inverted_clock_wne() -> i1
// CHECK: scf.for
...
func.func @bmc_derived_inverted_clock_wne() -> i1 {
  ...
  ^bb0(%clk: !seq.clock, %drv: i1, %sig: i1):
    ...
    %neq = comb.icmp wne %clk_i1, %drv : i1
    verif.assume %neq : i1
