...
// CHECK-LABEL: func.func @past_multiclock_any_posedge
// CHECK: scf.for
// CHECK: func.call @bmc_circuit
// The bmc_circuit function checks past buffer values with smt.eq
// CHECK-LABEL: func.func @bmc_circuit
// CHECK: smt.eq {{%.+}}, {{%.+}}
// CHECK: smt.and
func.func @past_multiclock_any_posedge() -> i1 {
