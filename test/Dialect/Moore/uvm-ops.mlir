...
moore.module @TestFactoryOps() {
  moore.procedure initial {
    // CHECK: moore.uvm.create_object "my_transaction" : !moore.class<@TestTransaction>
    %txn = moore.uvm.create_object "my_transaction" : !moore.class<@TestTransaction>

    // CHECK: moore.uvm.create_object "named_txn", "inst_name" : !moore.class<@TestTransaction>
    %named = moore.uvm.create_object "named_txn", "inst_name" : !moore.class<@TestTransaction>

    // CHECK: moore.uvm.create_component "my_comp", "comp0", %parent : !moore.class<@TestComponent> -> !moore.class<@TestComponent>
...
moore.module @TestPhaseOps() {
  moore.procedure initial {
    ...
    // CHECK: moore.uvm.raise_objection %phase : !moore.class<@TestUVMPhase>
    moore.uvm.raise_objection %phase : !moore.class<@TestUVMPhase>

    // CHECK: moore.uvm.raise_objection %phase, %count : !moore.class<@TestUVMPhase>
    moore.uvm.raise_objection %phase, %count : !moore.class<@TestUVMPhase>

    // CHECK: moore.uvm.drop_objection %phase : !moore.class<@TestUVMPhase>
    moore.uvm.drop_objection %phase : !moore.class<@TestUVMPhase>

    // CHECK: moore.uvm.drop_objection %phase, %count : !moore.class<@TestUVMPhase>
...
moore.module @TestConfigDbOps() {
  moore.procedure initial {
    ...
    // CHECK: moore.uvm.config_db.set "*.driver", "enable", %val : !moore.i32
    moore.uvm.config_db.set "*.driver", "enable", %val : !moore.i32

    // CHECK: moore.uvm.config_db.set %comp : !moore.class<@TestComponent>, "uvm_test_top.*", "cfg", %comp : !moore.class<@TestComponent>
    moore.uvm.config_db.set %comp : !moore.class<@TestComponent>, "uvm_test_top.*", "cfg", %comp : !moore.class<@TestComponent>

    // CHECK: moore.uvm.config_db.get %comp : !moore.class<@TestComponent>, "", "enable" -> !moore.i32
...
moore.module @TestSequenceOps() {
  moore.procedure initial {
    ...
    // CHECK: moore.uvm.sequence.start %seq, %sqr : !moore.class<@TestSequence>, !moore.class<@TestSequencer>
    moore.uvm.sequence.start %seq, %sqr : !moore.class<@TestSequence>, !moore.class<@TestSequencer>

    // CHECK: moore.uvm.sequence.start %seq, %sqr, parent %parent_seq : !moore.class<@TestSequence>
    ...
    // CHECK: moore.uvm.seq_item.start %item, %sqr : !moore.class<@TestItem>, !moore.class<@TestSequencer>
    moore.uvm.seq_item.start %item, %sqr : !moore.class<@TestItem>, !moore.class<@TestSequencer>

    // CHECK: moore.uvm.seq_item.finish %item, %sqr : !moore.class<@TestItem>, !moore.class<@TestSequencer>
    moore.uvm.seq_item.finish %item, %sqr : !moore.class<@TestItem>, !moore.class<@TestSequencer>

    // CHECK: moore.uvm.get_response %sqr : !moore.class<@TestSequencer> -> !moore.class<@TestItem>
...
moore.module @TestTLMOps() {
  moore.procedure initial {
    ...
    // CHECK: moore.uvm.tlm.put %port, %txn : !moore.class<@TestPort>, !moore.class<@TestTransaction>
    moore.uvm.tlm.put %port, %txn : !moore.class<@TestPort>, !moore.class<@TestTransaction>

    // CHECK: moore.uvm.tlm.get %port : !moore.class<@TestPort> -> !moore.class<@TestTransaction>
    %got = moore.uvm.tlm.get %port : !moore.class<@TestPort> -> !moore.class<@TestTransaction>

    // CHECK: moore.uvm.tlm.try_put %port, %txn : !moore.class<@TestPort>, !moore.class<@TestTransaction>
    %put_ok = moore.uvm.tlm.try_put %port, %txn : !moore.class<@TestPort>, !moore.class<@TestTransaction>

    // CHECK: moore.uvm.tlm.try_get %port : !moore.class<@TestPort> -> !moore.class<@TestTransaction>
    %get_ok, %try_got = moore.uvm.tlm.try_get %port : !moore.class<@TestPort> -> !moore.class<@TestTransaction>

    // CHECK: moore.uvm.tlm.analysis_write %port, %txn : !moore.class<@TestPort>, !moore.class<@TestTransaction>
...
moore.module @TestHierarchyOps() {
  moore.procedure initial {
    ...
    // CHECK: moore.uvm.get_parent %comp : !moore.class<@TestComponent> -> !moore.class<@TestComponent>
    %parent = moore.uvm.get_parent %comp : !moore.class<@TestComponent> -> !moore.class<@TestComponent>

    // CHECK: moore.uvm.get_full_name %comp : !moore.class<@TestComponent>
    %name = moore.uvm.get_full_name %comp : !moore.class<@TestComponent>

    // CHECK: moore.uvm.find_by_name "env.agent.driver" -> !moore.class<@TestComponent>
    %found = moore.uvm.find_by_name "env.agent.driver" -> !moore.class<@TestComponent>

    // CHECK: moore.uvm.find_by_name "agent.driver", %comp : !moore.class<@TestComponent> -> !moore.class<@TestComponent>
...
moore.module @TestTLMConnections() {
  moore.procedure initial {
    ...
    // CHECK: moore.uvm.tlm.connect %driver, %sqr : !moore.class<@TLMDriver>, !moore.class<@TLMSequencer>
    moore.uvm.tlm.connect %driver, %sqr : !moore.class<@TLMDriver>, !moore.class<@TLMSequencer>

    // CHECK: moore.uvm.analysis.connect %monitor, %scoreboard : !moore.class<@TestComponent>, !moore.class<@TestComponent>
