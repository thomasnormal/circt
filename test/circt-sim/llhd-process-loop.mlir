// RUN: circt-sim %s --top=test_loop --sim-stats 2>&1 | FileCheck %s
// REQUIRES: circt-sim

// Test a simple LLHD process loop with time advancement.
// The process waits twice for 1fs and then halts.
