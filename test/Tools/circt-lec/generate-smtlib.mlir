...
// CHECK-DAG: (declare-const c1_c (_ BitVec 8))
// CHECK-DAG: (declare-const c2_c (_ BitVec 8))
// CHECK: (assert (let ((tmp (bvadd a b)))
// CHECK:         (let ((tmp_0 (= c1_c tmp)))
// CHECK:         tmp_0)))
// CHECK: (assert (let ((tmp_1 (bvadd b a)))
// CHECK:         (let ((tmp_2 (= c2_c tmp_1)))
// CHECK:         tmp_2)))
// CHECK: (assert (let ((tmp_3 (distinct c1_c c2_c)))
// CHECK:         tmp_3))
// CHECK: (check-sat)
// CHECK: (reset)
