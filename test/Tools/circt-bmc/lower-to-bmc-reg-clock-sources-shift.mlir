...
// CHECK: verif.bmc bound 12 num_regs 2 initial_values [unit, unit] attributes {
...
// CHECK-SAME: bmc_reg_clock_sources = [{arg_index = 2 : i32, clock_key = "port:clk_a", invert = false}, {arg_index = 3 : i32, clock_key = "port:clk_b", invert = false}]
