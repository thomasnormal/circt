...
// RUN: not circt-bmc --run-smtlib -b 1 --module top --induction --liveness --liveness-lasso %s 2>&1 | FileCheck %s

// CHECK: --liveness/--liveness-lasso is incompatible with --induction/--k-induction
