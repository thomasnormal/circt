...
// RUN: circt-compile %s -o %t.so -v 2>&1 | FileCheck %s --check-prefix=COMPILE
...
// DISPATCH-DAG: [circt-sim] signal_updates_total:             {{[1-9][0-9]*}}
// DISPATCH-DAG: [circt-sim] edges_detected_total:             {{[1-9][0-9]*}}
// DISPATCH-DAG: [circt-sim] signal_updates_per_s:             {{[1-9][0-9]*}}
// DISPATCH-DAG: [circt-sim] edges_detected_per_s:             {{[1-9][0-9]*}}
// DISPATCH-DAG: [circt-sim] events_total:                     {{[1-9][0-9]*}}
// DISPATCH-DAG: [circt-sim] events_per_s:                     {{[1-9][0-9]*}}
