...
// LOG-DAG: [circt-sim] Strict JIT deopt process: id={{[1-9][0-9]*}} name=llhd_process_{{[0-9]+}} reason=unsupported_operation detail=first_op:func.call:local_helper_call_indirect_wait
// LOG-DAG: local_helper_call_indirect_static_suspending_unsupported
