...
//
// LOG: jit-process-thunk-wait-event-derived-observed-impure-prewait-unsupported
...
hw.module @top() {
  ...
  %fmt = sim.fmt.literal "jit-process-thunk-wait-event-derived-observed-impure-prewait-unsupported\0A"
