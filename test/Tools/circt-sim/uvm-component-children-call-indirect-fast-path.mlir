...
// Verify call_indirect fast paths for:
...
// Dummy function bodies return incorrect values; test only passes if
// call_indirect fast paths read m_children associative-array data directly.
...
module {
  ...
  hw.module @top() {
    %fmtPrefix = sim.fmt.literal "component-children call-indirect fast-path = "
    ...
    llhd.process {
      ...
      %fnNum = func.constant @"uvm_pkg::uvm_component::get_num_children" : (!llvm.ptr) -> i32
      %fnHas = func.constant @"uvm_pkg::uvm_component::has_child" : (!llvm.ptr, !llvm.struct<(ptr, i64)>) -> i1
      %fnGet = func.constant @"uvm_pkg::uvm_component::get_child" : (!llvm.ptr, !llvm.struct<(ptr, i64)>) -> !llvm.ptr
      %fnFirst = func.constant @"uvm_pkg::uvm_component::get_first_child" : (!llvm.ptr, !llvm.ptr) -> i32
      %fnNext = func.constant @"uvm_pkg::uvm_component::get_next_child" : (!llvm.ptr, !llvm.ptr) -> i32

      %numChildren = func.call_indirect %fnNum(%component) : (!llvm.ptr) -> i32
      %hasA = func.call_indirect %fnHas(%component, %nameA) : (!llvm.ptr, !llvm.struct<(ptr, i64)>) -> i1
      %hasZ = func.call_indirect %fnHas(%component, %nameZ) : (!llvm.ptr, !llvm.struct<(ptr, i64)>) -> i1
      ...
      %firstOk = func.call_indirect %fnFirst(%component, %iterNameRef) : (!llvm.ptr, !llvm.ptr) -> i32
      %firstName = llvm.load %iterNameRef : !llvm.ptr -> !llvm.struct<(ptr, i64)>
      %firstChild = func.call_indirect %fnGet(%component, %firstName) : (!llvm.ptr, !llvm.struct<(ptr, i64)>) -> !llvm.ptr

      %nextOk = func.call_indirect %fnNext(%component, %iterNameRef) : (!llvm.ptr, !llvm.ptr) -> i32
      %nextName = llvm.load %iterNameRef : !llvm.ptr -> !llvm.struct<(ptr, i64)>
      %nextChild = func.call_indirect %fnGet(%component, %nextName) : (!llvm.ptr, !llvm.struct<(ptr, i64)>) -> !llvm.ptr

      %endOk = func.call_indirect %fnNext(%component, %iterNameRef) : (!llvm.ptr, !llvm.ptr) -> i32
      %childAFound = func.call_indirect %fnGet(%component, %nameA) : (!llvm.ptr, !llvm.struct<(ptr, i64)>) -> !llvm.ptr
      %childZFound = func.call_indirect %fnGet(%component, %nameZ) : (!llvm.ptr, !llvm.struct<(ptr, i64)>) -> !llvm.ptr
