...
//
// Regression: config_db get through an MLIR wrapper function must still
// dispatch via the canonical call_indirect interception path and write through
...
module {
  ...
  func.func private @get_9010(%obj: !llvm.ptr, %inst: !llvm.struct<(ptr, i64)>,
    ...
    %slot = llvm.getelementptr %vptr[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2 x ptr>
  ...
  hw.module @test() {
    ...
    ^start:
      ...
      %ok = func.call @get_9010(%obj, %empty_str, %field, %slot1_ref)
