// RUN: rm -rf %t
// RUN: mkdir -p %t
// RUN: env CIRCT_SIM_JIT_CACHE_POLICY=none circt-sim %s --skip-passes --mode=compile --jit-hot-threshold=1 --jit-compile-budget=2 --jit-report=%t/jit.json > %t/log.txt 2>&1
