...
// Opt-in regression: singleton/registry accessors follow the UVM accessor gate.
//
...
func.func @"uvm_pkg::uvm_root::get_root_blocks"(%a: i32) -> i32 {
...
hw.module @test() {
  ...
  ^print:
    %r = func.call @"uvm_pkg::uvm_root::get_root_blocks"(%c5_i32) : (i32) -> i32
