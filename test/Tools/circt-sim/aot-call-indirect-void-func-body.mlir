...
// COMPILE-DAG: [circt-sim-compile] LowerTaggedIndirectCalls: lowered 1 indirect calls
// COMPILE-DAG: [circt-sim-compile] 3 functions + 0 processes ready for codegen
