...
// Regression: MAY_YIELD direct func.call stays interpreted by default, but
// opt-in should permit native dispatch when the active process model is
// coroutine-classified.
//
