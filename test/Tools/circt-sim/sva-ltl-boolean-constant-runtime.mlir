...
// Runtime semantics: ltl.boolean_constant false should fail immediately when
// checked as a clocked assertion property.
...
module {
  hw.module @top() {
    ...
    %p = ltl.boolean_constant false
    verif.clocked_assert %p, posedge %6 : !ltl.property
    hw.output
  }
}
