...
module {
  ...
  hw.module @test() {
    ...
    ^start:
      ...
      %set_slot_addr = llvm.getelementptr %vptr[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2 x ptr>
      %set_fptr = llvm.load %set_slot_addr : !llvm.ptr -> !llvm.ptr
      %set_fn = builtin.unrealized_conversion_cast %set_fptr : !llvm.ptr to (!llvm.ptr, !llvm.struct<(ptr, i64)>, !llvm.struct<(ptr, i64)>, !llvm.struct<(ptr, i64)>, !llvm.ptr) -> ()
      ...
      %ok = func.call_indirect %fn(%obj, %null, %empty_str, %field, %slot1_ref)
