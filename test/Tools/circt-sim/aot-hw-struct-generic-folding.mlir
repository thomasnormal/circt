...
// Regression: fold generic hw.struct_create/hw.struct_extract and
...
func.func @from_create(%x: i32) -> i32 {
  ...
  %s = hw.struct_create (%u, %x) : !hw.struct<a: i32, b: i32>
  %v = hw.struct_extract %s["b"] : !hw.struct<a: i32, b: i32>
  return %v : i32
}

func.func @from_agg() -> i32 {
  %s = hw.aggregate_constant [0 : i32, 42 : i32] : !hw.struct<a: i32, b: i32>
  %v = hw.struct_extract %s["b"] : !hw.struct<a: i32, b: i32>
  return %v : i32
}
