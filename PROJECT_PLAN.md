...
14. Mutation differential-BMC original-cache now supports configurable
    count/byte eviction policy (`--bmc-orig-cache-eviction-policy lru|fifo`)
    with matrix default/lane pass-through and telemetry export.
