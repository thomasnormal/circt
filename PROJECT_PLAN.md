...
- LEC now lowers trivial LLVM struct pack/unpack (`lower-lec-llvm`) and
  ...
  cast chains and block-argument forwarding), and dead-op cleanup to avoid
  leftover LLVM ops in LEC flows. Still limited for other LLVM dialect ops in
  formal inputs; widen lowering coverage.
