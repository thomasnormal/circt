...
run_lane() {
  ...
  lane_write_status() {
    printf "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n" \
      ...
      "$lane_generated_mutations_cache_lock_wait_ns" "$lane_generated_mutations_cache_lock_contended" > "$lane_status_file"
  }
