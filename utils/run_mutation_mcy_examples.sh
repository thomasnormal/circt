...
is_valid_native_mutation_op_token() {
  case "$1" in
    ...
    BA_TO_NBA|NBA_TO_BA|POSEDGE_TO_NEGEDGE|NEGEDGE_TO_POSEDGE|IF_COND_NEGATE|RESET_COND_NEGATE|RESET_COND_TRUE|RESET_COND_FALSE|IF_COND_TRUE|IF_COND_FALSE|IF_ELSE_SWAP_ARMS|MUX_SWAP_ARMS|MUX_FORCE_TRUE|MUX_FORCE_FALSE|\
