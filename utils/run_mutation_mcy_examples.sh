...
is_valid_native_mutation_op_token() {
  case "$1" in
    ...
    AND_TO_OR|OR_TO_AND|LAND_TO_BAND|LOR_TO_BOR|XOR_TO_OR|XOR_TO_XNOR|XNOR_TO_XOR|\
    BAND_TO_BOR|BOR_TO_BAND|BAND_TO_LAND|BOR_TO_LOR|UNARY_NOT_DROP|UNARY_BNOT_DROP|\
    BA_TO_NBA|NBA_TO_BA|POSEDGE_TO_NEGEDGE|NEGEDGE_TO_POSEDGE|IF_COND_NEGATE|MUX_SWAP_ARMS|\
    CONST0_TO_1|CONST1_TO_0|\
    ADD_TO_SUB|SUB_TO_ADD|MUL_TO_ADD|ADD_TO_MUL|DIV_TO_MUL|MUL_TO_DIV|UNARY_MINUS_DROP|\
