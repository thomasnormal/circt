...
is_valid_native_mutation_op_token() {
  case "$1" in
    ...
    ADD_TO_SUB|SUB_TO_ADD|MUL_TO_ADD|ADD_TO_MUL|DIV_TO_MUL|MUL_TO_DIV|MOD_TO_DIV|DIV_TO_MOD|UNARY_MINUS_DROP|INC_TO_DEC|DEC_TO_INC|PLUS_EQ_TO_MINUS_EQ|MINUS_EQ_TO_PLUS_EQ|MUL_EQ_TO_DIV_EQ|DIV_EQ_TO_MUL_EQ|SHL_EQ_TO_SHR_EQ|SHR_EQ_TO_SHL_EQ|SHR_EQ_TO_ASHR_EQ|ASHR_EQ_TO_SHR_EQ|\
