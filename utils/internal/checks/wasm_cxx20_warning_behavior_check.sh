...
cmd_lines_with_mixed_compilers="$(cat <<'EOF'
/opt/emsdk/upstream/emscripten/em++ -c tools/circt-tblgen/FIRRTLAnnotationsGen.cpp -std=c++20 -o FIRRTLAnnotationsGen.cpp.o
/usr/bin/clang++ -c tools/circt-tblgen/FIRRTLAnnotationsGen.cpp -std=c++20 -o FIRRTLAnnotationsGen.cpp.host.o
/opt/emsdk/upstream/emscripten/em++ -c tools/circt-tblgen/FIRRTLIntrinsicsGen.cpp -std=c++20 -o FIRRTLIntrinsicsGen.cpp.o
/usr/bin/clang++ -c tools/circt-tblgen/FIRRTLIntrinsicsGen.cpp -std=c++20 -o FIRRTLIntrinsicsGen.cpp.host.o
/opt/emsdk/upstream/emscripten/em++ -c tools/circt-tblgen/circt-tblgen.cpp -std=c++20 -o circt-tblgen.cpp.o
/usr/bin/clang++ -c tools/circt-tblgen/circt-tblgen.cpp -std=c++20 -o circt-tblgen.cpp.host.o
EOF
)"
...
run_case "mixed-compilers-prefers-emscripten" "$cmd_lines_with_mixed_compilers" 0
