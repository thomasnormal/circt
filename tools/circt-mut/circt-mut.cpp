...
static void printInitHelp(raw_ostream &os) {
  ...
  os << "                            native-strict-formal-compile-debt|\n";
  os << "                            strict-formal-compile-debt|\n";
  os << "                            native-strict-formal-compile-strict|\n";
  ...
  os << "                            strict-formal-quality-nightly|\n";
...
static void printReportHelp(raw_ostream &os) {
  ...
  os << "                           formal-regression-matrix-external-formal-bmc-provenance-check-identity-trend-guard-v1|\n";
  os << "                           formal-regression-matrix-external-formal-bmc-provenance-check-identity-digest-trend-guard-v1|\n";
  os << "                           formal-regression-matrix-external-formal-nonempty-filter-contract-v1|\n";
  os << "                           formal-regression-matrix-external-formal-sv-tests-bmc-min-total-v1|\n";
  ...
  os << "                           formal-regression-matrix-external-formal-bmc-core-min-total-v1|\n";
  ...
  os << "                           formal-regression-matrix-external-formal-compile-mode-budget-strict-v1|\n";
  ...
  os << "                           formal-regression-matrix-composite-native-strict-formal-trend-v4|\n";
  os << "                           formal-regression-matrix-composite-native-strict-formal-trend-v5|\n";
  os << "                           formal-regression-matrix-composite-native-strict-formal-trend-v6|\n";
  os << "                           formal-regression-matrix-composite-native-strict-formal-trend-v7|\n";
  os << "                           formal-regression-matrix-composite-native-strict-formal-trend-v8|\n";
  ...
  os << "                           formal-regression-matrix-composite-native-strict-formal-trend-v13|\n";
  os << "                           formal-regression-matrix-composite-native-strict-formal-trend-v14|\n";
  os << "                           formal-regression-matrix-composite-native-strict-formal-trend-v15|\n";
  os << "                           formal-regression-matrix-composite-native-strict-formal-trend-v16|\n";
  ...
  os << "                           formal-regression-matrix-composite-stop-on-fail-native-strict-formal-trend-v4|\n";
  os << "                           formal-regression-matrix-composite-stop-on-fail-native-strict-formal-trend-v5|\n";
  os << "                           formal-regression-matrix-composite-stop-on-fail-native-strict-formal-trend-v6|\n";
  os << "                           formal-regression-matrix-composite-stop-on-fail-native-strict-formal-trend-v7|\n";
  os << "                           formal-regression-matrix-composite-stop-on-fail-native-strict-formal-trend-v8|\n";
  ...
  os << "                           formal-regression-matrix-composite-stop-on-fail-native-strict-formal-trend-v13|\n";
  os << "                           formal-regression-matrix-composite-stop-on-fail-native-strict-formal-trend-v14|\n";
  os << "                           formal-regression-matrix-composite-stop-on-fail-native-strict-formal-trend-v15|\n";
  os << "                           formal-regression-matrix-composite-stop-on-fail-native-strict-formal-trend-v16|\n";
...
static bool isMatrixPolicyMode(StringRef mode) {
  return mode == "smoke" || mode == "nightly" || mode == "strict" ||
         ...
         mode == "native-strict-formal-compile-debt" ||
         mode == "strict-formal-compile-debt" ||
         mode == "native-strict-formal-compile-strict" ||
...
static bool appendMatrixPolicyModeProfiles(StringRef mode, bool stopOnFail,
  ...
  if (mode == "smoke") {
    ...
    externalFormalSummaryV1Profile =
        "formal-regression-matrix-external-formal-summary-v1-guard";
  } else if (mode == "native-strict-formal-compile-debt") {
    policyProfile = stopOnFail
                        ? "formal-regression-matrix-composite-stop-on-fail-native-strict"
                        : "formal-regression-matrix-composite-native-strict";
    externalFormalCompileProfile =
        "formal-regression-matrix-external-formal-compile-mode-budget-debt-v1";
    modeContractProfile =
        "formal-regression-matrix-policy-mode-native-strict-contract";
  } else if (mode == "strict-formal-compile-debt") {
    policyProfile = stopOnFail
                        ? "formal-regression-matrix-composite-stop-on-fail-strict"
                        : "formal-regression-matrix-composite-strict";
    provenanceProfile = "formal-regression-matrix-provenance-strict";
    externalFormalCompileProfile =
        "formal-regression-matrix-external-formal-compile-mode-budget-debt-v1";
  } else if (mode == "native-strict-formal-compile-strict") {
    policyProfile = stopOnFail
                        ? "formal-regression-matrix-composite-stop-on-fail-native-strict"
                        : "formal-regression-matrix-composite-native-strict";
    externalFormalCompileProfile =
    ...
    modeContractProfile =
        "formal-regression-matrix-policy-mode-native-strict-contract";
  } else if (mode == "strict-formal-compile-strict") {
    policyProfile = stopOnFail
                        ? "formal-regression-matrix-composite-stop-on-fail-strict"
                        : "formal-regression-matrix-composite-strict";
    provenanceProfile = "formal-regression-matrix-provenance-strict";
    externalFormalCompileProfile =
        "formal-regression-matrix-external-formal-compile-mode-budget-strict-v1";
  } else if (mode == "native-strict-formal-timeout-debt") {
    policyProfile = stopOnFail
                        ? "formal-regression-matrix-composite-stop-on-fail-native-strict"
                        : "formal-regression-matrix-composite-native-strict";
    ...
    modeContractProfile =
        "formal-regression-matrix-policy-mode-native-strict-contract";
  } else if (mode == "strict-formal-timeout-debt") {
    policyProfile = stopOnFail
                        ? "formal-regression-matrix-composite-stop-on-fail-strict"
                        : "formal-regression-matrix-composite-strict";
    provenanceProfile = "formal-regression-matrix-provenance-strict";
    ...
    externalFormalLecCoreMinProfile =
        "formal-regression-matrix-external-formal-lec-core-min-total-v1";
  } else if (mode == "native-strict-formal-timeout-strict") {
    policyProfile = stopOnFail
                        ? "formal-regression-matrix-composite-stop-on-fail-native-strict"
                        : "formal-regression-matrix-composite-native-strict";
    externalFormalTimeoutProfile =
    ...
    modeContractProfile =
        "formal-regression-matrix-policy-mode-native-strict-contract";
  } else if (mode == "strict-formal-timeout-strict") {
    policyProfile = stopOnFail
                        ? "formal-regression-matrix-composite-stop-on-fail-strict"
                        : "formal-regression-matrix-composite-strict";
    provenanceProfile = "formal-regression-matrix-provenance-strict";
    ...
    externalFormalLecCoreMinProfile =
        "formal-regression-matrix-external-formal-lec-core-min-total-v1";
  } else if (mode == "native-strict-formal-quality-strict") {
    policyProfile = stopOnFail
                        ? "formal-regression-matrix-composite-stop-on-fail-native-strict"
                        : "formal-regression-matrix-composite-native-strict";
    externalFormalTimeoutProfile =
    ...
    modeContractProfile =
        "formal-regression-matrix-policy-mode-native-strict-contract";
  } else if (mode == "strict-formal-quality-strict") {
    policyProfile = stopOnFail
                        ? "formal-regression-matrix-composite-stop-on-fail-strict"
                        : "formal-regression-matrix-composite-strict";
    provenanceProfile = "formal-regression-matrix-provenance-strict";
  ...
  if (!externalFormalCompileProfile.empty())
  ...
  if (!externalFormalLecCoreMinProfile.empty())
    out.push_back(externalFormalLecCoreMinProfile);
...
static bool applyPolicyProfile(StringRef profile, ReportOptions &opts,
  ...
  if (profile ==
    ...
    for (StringRef key : {
             "external_formal.summary_counter_by_suite_mode.sv_tests.LEC.lec_error_bucket_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.sv_tests.LEC.lec_semantic_diag_subfamily_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.sv_tests.LEC.lec_semantic_diag_subfamily_case_reasons_cardinality",
             "external_formal.summary_counter_by_suite_mode.sv_tests.LEC.lec_runner_command_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.sv_tests.LEC.lec_runner_command_case_reasons_cardinality",
             "external_formal.summary_counter_by_suite_mode.sv_tests.LEC.lec_circt_opt_error_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.sv_tests.LEC.lec_circt_opt_error_case_reasons_cardinality",
             "external_formal.summary_counter_by_suite_mode.sv_tests.LEC.lec_circt_verilog_error_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.sv_tests.LEC.lec_circt_verilog_error_case_reasons_cardinality",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.LEC.lec_error_bucket_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.LEC.lec_semantic_diag_subfamily_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.LEC.lec_semantic_diag_subfamily_case_reasons_cardinality",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.LEC.lec_runner_command_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.LEC.lec_runner_command_case_reasons_cardinality",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.LEC.lec_circt_opt_error_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.LEC.lec_circt_opt_error_case_reasons_cardinality",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.LEC.lec_circt_verilog_error_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.LEC.lec_circt_verilog_error_case_reasons_cardinality",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.LEC.lec_error_bucket_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.LEC.lec_semantic_diag_subfamily_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.LEC.lec_semantic_diag_subfamily_case_reasons_cardinality",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.LEC.lec_runner_command_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.LEC.lec_runner_command_case_reasons_cardinality",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.LEC.lec_circt_opt_error_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.LEC.lec_circt_opt_error_case_reasons_cardinality",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.LEC.lec_circt_verilog_error_case_ids_cardinality",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.LEC.lec_circt_verilog_error_case_reasons_cardinality",
         }) {
      appendUniqueRule(opts.failIfTrendDeltaGtRules, key, 0.0);
    }
    return applyComposite("formal-regression-matrix-trend-history-quality");
  ...
  if (profile ==
    ...
    for (StringRef key : {
             "external_formal.summary_counter_by_suite_mode.sv_tests.BMC.bmc_abstraction_provenance_tokens",
             "external_formal.summary_counter_by_suite_mode.sv_tests.BMC.bmc_ir_check_fingerprint_cardinality",
             "external_formal.summary_counter_by_suite_mode.sv_tests.BMC.bmc_ir_check_key_cardinality",
             "external_formal.summary_counter_by_suite_mode.sv_tests_uvm.BMC_SEMANTICS.bmc_abstraction_provenance_tokens",
             "external_formal.summary_counter_by_suite_mode.sv_tests_uvm.BMC_SEMANTICS.bmc_ir_check_fingerprint_cardinality",
             "external_formal.summary_counter_by_suite_mode.sv_tests_uvm.BMC_SEMANTICS.bmc_ir_check_key_cardinality",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.BMC.bmc_abstraction_provenance_tokens",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.BMC.bmc_ir_check_fingerprint_cardinality",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.BMC.bmc_ir_check_key_cardinality",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.BMC.bmc_abstraction_provenance_tokens",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.BMC.bmc_ir_check_fingerprint_cardinality",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.BMC.bmc_ir_check_key_cardinality",
         }) {
      appendUniqueRule(opts.failIfTrendDeltaGtRules, key, 0.0);
    }
    return applyComposite("formal-regression-matrix-trend-history-quality");
  ...
  if (profile ==
    ...
    for (StringRef key : {
             "external_formal.summary_counter_by_suite_mode.sv_tests.BMC.bmc_abstraction_provenance_identity_digest_u64",
             "external_formal.summary_counter_by_suite_mode.sv_tests.BMC.bmc_ir_check_key_identity_digest_u64",
             "external_formal.summary_counter_by_suite_mode.sv_tests.BMC.bmc_ir_check_fingerprint_identity_digest_u64",
             "external_formal.summary_counter_by_suite_mode.sv_tests_uvm.BMC_SEMANTICS.bmc_abstraction_provenance_identity_digest_u64",
             "external_formal.summary_counter_by_suite_mode.sv_tests_uvm.BMC_SEMANTICS.bmc_ir_check_key_identity_digest_u64",
             "external_formal.summary_counter_by_suite_mode.sv_tests_uvm.BMC_SEMANTICS.bmc_ir_check_fingerprint_identity_digest_u64",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.BMC.bmc_abstraction_provenance_identity_digest_u64",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.BMC.bmc_ir_check_key_identity_digest_u64",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.BMC.bmc_ir_check_fingerprint_identity_digest_u64",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.BMC.bmc_abstraction_provenance_identity_digest_u64",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.BMC.bmc_ir_check_key_identity_digest_u64",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.BMC.bmc_ir_check_fingerprint_identity_digest_u64",
         }) {
      appendUniqueRule(opts.failIfTrendDeltaGtRules, key, 0.0);
      appendUniqueRule(opts.failIfTrendDeltaLtRules, key, 0.0);
    }
    return applyComposite("formal-regression-matrix-trend-history-quality");
  }
  if (profile ==
    ...
    for (StringRef key : {
             "external_formal.summary_counter_by_suite_mode.sv_tests.BMC.nonempty_filter_miss",
             "external_formal.summary_counter_by_suite_mode.sv_tests.LEC.nonempty_filter_miss",
             "external_formal.summary_counter_by_suite_mode.sv_tests_uvm.BMC_SEMANTICS.nonempty_filter_miss",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.BMC.nonempty_filter_miss",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.LEC.nonempty_filter_miss",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.BMC.nonempty_filter_miss",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.LEC.nonempty_filter_miss",
         }) {
      appendUniqueRule(opts.failIfValueGtRules, key, 0.0);
    }
    return true;
  ...
  if (profile ==
    ...
    appendUniqueRule(
        opts.failIfValueLtRules,
        "external_formal.summary_status_by_suite_mode.sv_tests.BMC.total", 1.0);
    return true;
  }
  if (profile ==
      "formal-regression-matrix-external-formal-filtered-lane-min-total-violation-v1") {
    for (StringRef key : {
             "external_formal.summary_counter_by_suite_mode.sv_tests.BMC.filtered_min_total_violation",
             "external_formal.summary_counter_by_suite_mode.sv_tests.LEC.filtered_min_total_violation",
             "external_formal.summary_counter_by_suite_mode.sv_tests_uvm.BMC_SEMANTICS.filtered_min_total_violation",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.BMC.filtered_min_total_violation",
             "external_formal.summary_counter_by_suite_mode.verilator_verification.LEC.filtered_min_total_violation",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.BMC.filtered_min_total_violation",
             "external_formal.summary_counter_by_suite_mode.yosys_tests_sva.LEC.filtered_min_total_violation",
         }) {
      appendUniqueRule(opts.failIfValueGtRules, key, 0.0);
    }
    return true;
  ...
  if (profile ==
    ...
    for (StringRef key : {
             ...
             "external_formal.summary_counter_by_suite_mode.opentitan.LEC.lec_timeout_stage_frontend_cases",
             "external_formal.summary_counter_by_suite_mode.opentitan.LEC.lec_timeout_stage_solver_cases",
             "external_formal.summary_counter_by_suite_mode.opentitan.LEC.lec_timeout_stage_unknown_cases",
             "external_formal.summary_counter_by_suite_mode.opentitan.LEC_STRICT.lec_timeout_stage_frontend_cases",
             "external_formal.summary_counter_by_suite_mode.opentitan.LEC_STRICT.lec_timeout_stage_solver_cases",
             "external_formal.summary_counter_by_suite_mode.opentitan.LEC_STRICT.lec_timeout_stage_unknown_cases",
         }) {
      appendUniqueRule(opts.failIfTrendDeltaGtRules, key, 0.0);
    }
    return applyComposite("formal-regression-matrix-trend-history-quality");
  ...
  if (profile ==
      "formal-regression-matrix-external-formal-bmc-core-min-total-v1") {
    for (StringRef key : {
             "external_formal.summary_status_by_suite_mode.sv_tests.BMC.total",
             "external_formal.summary_status_by_suite_mode.sv_tests_uvm.BMC_SEMANTICS.total",
             "external_formal.summary_status_by_suite_mode.verilator_verification.BMC.total",
             "external_formal.summary_status_by_suite_mode.yosys_tests_sva.BMC.total",
         }) {
      appendUniqueRule(opts.failIfValueLtRules, key, 1.0);
    }
    return true;
  }
  auto appendCoreTimeoutStageBudget = [&](double limit) {
    for (StringRef key : {
             "external_formal.summary_counter_by_suite_mode.sv_tests.BMC.bmc_timeout_stage_frontend_cases",
             "external_formal.summary_counter_by_suite_mode.sv_tests.BMC.bmc_timeout_stage_solver_cases",
             "external_formal.summary_counter_by_suite_mode.sv_tests.BMC.bmc_timeout_stage_unknown_cases",
      ...
      appendUniqueRule(opts.failIfValueGtRules, key, limit);
    }
    return true;
  };
  if (profile ==
      "formal-regression-matrix-external-formal-core-timeout-stage-budget-v1") {
    return appendCoreTimeoutStageBudget(0.0);
  }
  if (profile ==
      "formal-regression-matrix-external-formal-core-timeout-stage-budget-strict-v1") {
    return appendCoreTimeoutStageBudget(0.0);
...
static int runNativeReport(const ReportOptions &opts) {
  ...
  rows.emplace_back("policy.mode_is_native_strict",
                    (!appliedPolicyMode.empty() &&
                     StringRef(appliedPolicyMode).starts_with("native-strict"))
                        ? "1"
                        : "0");
...
static void circtOnlyNativeOpsForMode(StringRef modeName,
  ...
  if (modeName == "arith") {
    appendAll({"EQ_TO_NEQ", "NEQ_TO_EQ", "LT_TO_LE", "GT_TO_GE", "LE_TO_LT",
               ...
               "CMP_CONST_PLUS_ONE", "CMP_CONST_MINUS_ONE",
               ...
               "ASSIGN_RHS_ADD_LHS", "ASSIGN_RHS_SUB_LHS",
               "ASSIGN_RHS_PLUS_ONE", "ASSIGN_RHS_MINUS_ONE",
               "ASSIGN_RHS_NEGATE", "ASSIGN_RHS_SHL_ONE",
               "ASSIGN_RHS_SHR_ONE", "ASSIGN_RHS_ASHR_ONE",
               "MUL_EQ_TO_DIV_EQ", "DIV_EQ_TO_MUL_EQ", "MOD_EQ_TO_DIV_EQ",
               "DIV_EQ_TO_MOD_EQ", "SHL_EQ_TO_SHR_EQ",
               "SHR_EQ_TO_SHL_EQ", "SHR_EQ_TO_ASHR_EQ", "ASHR_EQ_TO_SHR_EQ",
               "SHL_TO_SHR",
  ...
  if (modeName == "control") {
    appendAll({"AND_TO_OR", "OR_TO_AND", "LAND_TO_BAND", "LOR_TO_BOR",
               ...
               "MUX_FORCE_TRUE", "MUX_FORCE_FALSE", "CASE_TO_CASEZ",
               "CASEZ_TO_CASE", "CASE_TO_CASEX", "CASEX_TO_CASE",
  ...
  if (modeName == "invert") {
    appendAll({"EQ_TO_NEQ", "NEQ_TO_EQ", "LT_TO_LE", "GT_TO_GE", "LE_TO_LT",
               ...
               "BXOR_EQ_TO_BOR_EQ", "BXOR_EQ_TO_BAND_EQ",
               "BAND_EQ_TO_BXOR_EQ", "BOR_EQ_TO_BXOR_EQ",
               "BA_TO_NBA", "NBA_TO_BA", "ASSIGN_RHS_TO_LHS",
               "ASSIGN_RHS_OR_LHS", "ASSIGN_RHS_AND_LHS",
               ...
               "ADD_TO_SUB", "SUB_TO_ADD", "MUL_TO_ADD", "ADD_TO_MUL",
               "DIV_TO_MUL", "MUL_TO_DIV", "MOD_TO_DIV", "DIV_TO_MOD", "UNARY_MINUS_DROP", "INC_TO_DEC",
               "DEC_TO_INC", "ASSIGN_RHS_ADD_LHS", "ASSIGN_RHS_SUB_LHS",
               "ASSIGN_RHS_PLUS_ONE", "ASSIGN_RHS_MINUS_ONE",
               "ASSIGN_RHS_NEGATE", "ASSIGN_RHS_SHL_ONE",
               "ASSIGN_RHS_SHR_ONE", "ASSIGN_RHS_ASHR_ONE",
  ...
  if (modeName == "connect") {
    appendAll({"AND_TO_OR", "OR_TO_AND", "LAND_TO_BAND", "LOR_TO_BOR",
               ...
               "BXOR_EQ_TO_BOR_EQ", "BXOR_EQ_TO_BAND_EQ",
               "BAND_EQ_TO_BXOR_EQ", "BOR_EQ_TO_BXOR_EQ",
               "BA_TO_NBA", "NBA_TO_BA", "ASSIGN_RHS_TO_CONST0",
               "ASSIGN_RHS_TO_CONST1", "ASSIGN_RHS_TO_LHS",
               "ASSIGN_RHS_OR_LHS", "ASSIGN_RHS_AND_LHS",
               "ASSIGN_RHS_XOR_LHS", "ASSIGN_RHS_INVERT",
               "POSEDGE_TO_NEGEDGE",
               "NEGEDGE_TO_POSEDGE", "RESET_POSEDGE_TO_NEGEDGE",
